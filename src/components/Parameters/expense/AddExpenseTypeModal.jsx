...
const AddExpenseTypeModal = ({ title, onClose, selectedFlatType }) => {
  const { addExpenseTypeMutation, updateExpenseTypeMutation } =
    useExpenseType();

  const handleSubmit = (formValues) => {
    if (!selectedFlatType) {
      addExpenseTypeMutation(formValues);
    } else {
      let payload = {
        id: selectedFlatType.id,
        ...formValues,
      };
      updateExpenseTypeMutation(payload);
    }
