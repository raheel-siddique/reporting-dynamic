...
const AddChequeModal = ({
  ...
  if (initialValues) {
    ...
    datedOrOpenExists = isNaN(datedOrOpen)
      ? DatedOrOpenEnum[datedOrOpen]
      : datedOrOpen;
  }

  return (
    <div className="fixed h-full top-0 bg-[#1E1E1E33] left-0 right-0 z-50 w-full p-3 overflow-x-hidden overflow-y-auto flex justify-center items-center ">
                ...
                cheques: [
                  {
                    ...
                    vat: null,
                    discount: null,
                    depositType: DepositType.Rent.value,
                    ...initialValues, // Spread existing initialValues (if editing an existing cheque)
                    bankId: bankTypesData
                      ? bankTypesData.find(
                          (bank) => bank.id == initialValues.bankId
                        )?.name || ""
                      : "",
                    depositBankId: bankTypesData
                      ? bankTypesData.find(
                          (bank) => bank.id == initialValues.depositBankId
                        )?.name || ""
                      : "",
                    datedOrOpen: datedOrOpenExists
                      ...
                      : DatedOrOpen.Open.label,
                    amountTypeText: isNaN(initialValues.amountType)
                      ? initialValues.amountType
                      : AmountTypeEnumReverse[initialValues.amountType],
                  },
                ],
              }}
                            ...
                            return (
                              ...
                              >
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                  ...
                                  <div>
                                    <label
                                      htmlFor={`cheques.${index}.amountTypeText`}
                                    ...
                                    <ReusableInput
                                      // type={"text"}
                                      inpName={`cheques.${index}.amountTypeText`}
                                      inpPlaceholder=""
                                      readOnly={viewOnly}
                                  ...
                                  <div>
                                    <label
                                      htmlFor={`cheques.${index}.datedOrOpen`}
                                      className="text-sm font-medium"
                                    >
                                      Dated/Open
                                    </label>
                                    <ReusableInput
                                      // type={"text"}
                                      inpName={`cheques.${index}.datedOrOpen`}
                                      inpPlaceholder=""
                                      readOnly={viewOnly}
                                      showDisabledClasses={false}
                                    />
                                  ...
                                  {values.cheques[
                                    ...
                                    <div>
                                      ...
                                      <div className="custom-select relative">
                                        <ReusableInput
                                          type={"text"}
                                          inpName={`cheques.${index}.bankId`}
                                          inpPlaceholder="Bank Name"
                                          readOnly={viewOnly}
                                          showDisabledClasses={false}
                                        />
                                  ...
                                  {values.cheques[
                                    ...
                                    <div>
                                      ...
                                      <div className="custom-select relative">
                                        <ReusableInput
                                          type={"text"}
                                          inpName={`cheques.${index}.depositBankId`}
                                          inpPlaceholder="Deposit Bank Name"
                                          readOnly={viewOnly}
                                          showDisabledClasses={false}
                                        />
                                  ...
                                  {values.cheques[
                                    ...
                                    <div>
                                      ...
                                      <div className="custom-select">
                                        <ReusableInput
                                          type={"text"}
                                          inpName={`cheques.${index}.statusText`}
                                          inpPlaceholder="Cheque Status"
                                          readOnly={viewOnly}
                                          showDisabledClasses={false}
                                        />
